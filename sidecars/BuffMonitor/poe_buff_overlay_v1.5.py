"""
Standalone PoE2 Rend overlay prototype v1.5.
...
Run:
  python.exe poe_buff_overlay_v1.5.py
...
class BuffOverlay:
    def __init__(self):
        ...
        self.thresholds["rend"] = self.app_settings[
            "rend_threshold"
        ]

        self.thresholds["power_charge"] = self.app_settings[
            "power_charge_threshold"
        ]
        ...
        self.root.geometry(
            f'+{self.app_settings["overlay_x"]}'
            f'+{self.app_settings["overlay_y"]}'
)
