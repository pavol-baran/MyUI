"""
Standalone PoE2 Rend overlay prototype v1.6.1
...
Run:
  python.exe poe_buff_overlay_v1.6.1.py
...
class BuffOverlay:
    ...
    def update_overlay_visibility(self):
        ...
        if should_show == self.overlay_actually_visible:
            return
    ...
    def run(self):
        ...
        print(
            "v1.6.1: PoE-aware visibility, paused detection, "
            "and automatic overlay restoration."
        )
        self.root.mainloop()
